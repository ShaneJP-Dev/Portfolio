...
// Component handles the background of the website
const Hero = () => {
  return (
    <div className="pb-20 pt-36 relative">
        
        <div>
            {/* Spotlight in top corners with animation */}
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="maw-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            ...
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
              Hi, I&apos;m Shane, a Next.js Developer based in South Africa
            </p>
